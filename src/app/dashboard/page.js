            ...
            <section>
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2">
                  <button className="px-4 py-1.5 text-sm bg-[#3a344a] rounded-full hover:bg-[#4A3E5E] text-white">
                    All
                  </button>
                  <button className="px-4 py-1.5 text-sm bg-[#3a344a] rounded-full hover:bg-[#4A3E5E]">
                    New Arrivals
                  </button>
                  <button className="px-4 py-1.5 text-sm bg-[#3a344a] rounded-full hover:bg-[#4A3E5E]">
                    Trending
                  ...
                  <div key={outfit.name} className="group cursor-pointer">
                    <div className="relative aspect-[3/4] rounded-lg overflow-hidden bg-[#242131]">
                      <img
                        ...
                        alt={outfit.name}
                        layout="fill"
                        className="object-contain object-center p-4 group-hover:scale-105 
                        transition-transform duration-300 w-[100%] h-[100%]"
                      />
                    </div>
